...
This would be completely impractical in sectors where security is paramount but there is a lot of data to protect, such as banking, but these are typically businesses that can afford high-tech security measures. We need to question whether knowledge workers in general have seen greater efficiencies since the replacement of postal communications and filing cabinets.[^3] Poor methods of information capture and retrieval and hard drives of disorganised electronic files are all too common.
